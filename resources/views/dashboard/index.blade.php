...
<div style="background:linear-gradient(135deg,#0a7a3d 0%,#0a4d26 60%,#083d1e 100%);margin:-22px -22px 0;padding:26px 26px 56px;">
  <div class="d-flex justify-content-between align-items-start gap-2">
    ...
    <span class="px-3 py-1 fw-bold" style="border:1.5px solid #fff;color:#fff;border-radius:50px;font-size:11px;letter-spacing:1px">GURU TUGAS</span>
  </div>
</div>
...
<div class="p-3 p-md-4 mb-3 rounded-4 position-relative overflow-hidden" style="background:linear-gradient(120deg,#0c5a2e 0%,#083d1e 55%,#062b15 100%);color:#fff;margin-top:-38px;box-shadow:0 12px 32px rgba(6,43,21,.35);border:1px solid rgba(212,175,55,.35)">
  ...
  <div class="d-flex align-items-center gap-3 position-relative">
    <div style="width:56px;height:56px;border-radius:18px;background:rgba(255,255,255,.95);display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 6px 18px rgba(0,0,0,.25)"><img src="{{ asset('images/madin.png') }}" alt="" style="width:40px;height:40px;object-fit:contain"></div>
  ...
  <div class="col-6 col-lg-2 col-md-4">
    <div class="card h-100" style="border:2px solid var(--gold);border-radius:16px;background:#fff;box-shadow:0 4px 16px rgba(10,61,31,.06)">
      <div class="card-body p-3 d-flex align-items-center gap-2">
        ...
        <div><div class="small" style="color:#8a7a3a;font-weight:600;font-size:11px">@if($isGt ?? false) Tugas Saya @else Total @endif</div><div class="fw-bold" style="color:var(--green);font-size:20px;line-height:1">{{ $total }}</div><div class="small arab" style="color:var(--gold);font-size:10px">الكل</div></div>
      </div>
    </div>
  </div>
  @unless($isGt ?? false)
  ...
  <div class="col-6 col-lg-2 col-md-4">
    <div class="card h-100" style="border:2px solid #198754;border-radius:16px;background:#fff;">
      <div class="card-body p-3 d-flex align-items-center gap-2">
        ...
        <div><div class="small" style="color:#8a7a3a;font-weight:600;font-size:11px">@if($isGt ?? false) Tugas Aktif @else Diterima @endif</div><div class="fw-bold" style="color:#198754;font-size:20px;line-height:1">{{ $diterima }}</div><div class="small arab" style="color:#198754;font-size:10px">مقبول</div></div>
      </div>
    </div>
  </div>
  @unless($isGt ?? false)
